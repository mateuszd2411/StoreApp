package com.example.sklep.ViewHolder;
...
import com.example.sklep.Interface.ItemClickListener;
import com.example.sklep.R;




public class ItemNewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public ItemNewHolder(@NonNull View itemView) {
