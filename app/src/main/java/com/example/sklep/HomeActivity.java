...
public class HomeActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!type.equals("Admin")){
            userNameTextView.setText(Prevalent.currrentOnlineUser.getName());
            Picasso.get().load(Prevalent.currrentOnlineUser.getImage()).placeholder(R.drawable.profile).into(profileImageView);
