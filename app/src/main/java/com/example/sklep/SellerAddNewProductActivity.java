...
public class SellerAddNewProductActivity extends AppCompatActivity {
  ...
  private String CategoryName, Description, Priice, Pname, saveCurrentData, saveCurrentTime;
  ...
  private void ValidateProductData(){
    ...
    Priice = InputProductPrice.getText().toString();
    ...
    }else if(TextUtils.isEmpty(Priice)){
